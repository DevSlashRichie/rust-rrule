...
fn secondly_by_minute_and_second() {
    ...
    test_recurring_rrule(
        ...
        ymd_hms(1997, 9, 2, 9, 0, 0),
        &[
            (ymd_hms(1997, 9, 2, 9, 6, 6), 0),
            (ymd_hms(1997, 9, 2, 9, 6, 18), 0),
            (ymd_hms(1997, 9, 2, 9, 18, 6), 0)
        ],
    );
}
...
fn secondly_by_hour_and_minute_and_second() {
    ...
    test_recurring_rrule(
        ...
        ymd_hms(1997, 9, 2, 9, 0, 0),
        &[
            (ymd_hms(1997, 9, 2, 18, 6, 6), 0),
            (ymd_hms(1997, 9, 2, 18, 6, 18), 0),
            (ymd_hms(1997, 9, 2, 18, 18, 6), 0),
            (ymd_hms(1997, 9, 2, 18, 18, 18), 0),
            (ymd_hms(1997, 9, 3, 6, 6, 6), 0),
        ],
    );
}
...
fn until_not_matching() {
    ...
    test_recurring_rrule(
        ...
        &[
            ...
            (ymd_hms(1997, 9, 3, 9, 0, 0), 0),
            (ymd_hms(1997, 9, 4, 9, 0, 0), 0),
        ],
    );
}
...
fn test_before_inclusive_hit() {
    ...
    assert_eq!(Some(&(before, 0)), rrule.all_unchecked().last());
}
...
fn test_before_inclusive_miss() {
    ...
    assert_eq!(Some(&(oracle, 0)), rrule.all_unchecked().last());
}
...
fn test_after_inclusive_hit() {
    ...
    assert_eq!((after, 0), rrule.all(1).dates[0]);
}
...
fn test_after_inclusive_miss() {
    ...
    assert_eq!((oracle, 0), rrule.all(1).dates[0]);
}
...
fn test_between_inclusive_both_miss() {
    ...
    assert_eq!(vec![(middle, 0)], rrule.all_unchecked());
}
...
fn test_between_inclusive_lower_miss() {
    ...
    assert_eq!(vec![(middle, 0), (before, 0)], rrule.all_unchecked());
}
...
fn test_between_inclusive_upper_miss() {
    ...
    assert_eq!(vec![(after, 0), (middle, 0)], rrule.all_unchecked());
}
